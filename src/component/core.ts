...
export default class Core {
  ...
  public enterKeyPressed(event: any) {
    ...
    const newNode = this.ui.createBlock('div', block, this.blockData.length);
  ...
  public make() {
    /** 创建包装器 */
    const wrapper = this.ui.createWrapper();
    ...
    const redactor = this.ui.createRedactor();
    ...
    const block = this.ui.createBlock('div', b);
